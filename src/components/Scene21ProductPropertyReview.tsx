...
export default function Scene21ProductPropertyReview({ onNext, onPrev }: { onNext: () => void, onPrev: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-center space-y-8 w-full max-w-4xl mx-auto">
      <h2 className="text-3xl font-bold text-slate-800">Review: Product of Powers</h2>
      ...
      <div className="w-full max-w-3xl bg-white p-10 rounded-2xl shadow-sm border border-slate-200 space-y-8">
        ...
        <div className="bg-purple-50 p-8 rounded-xl border-2 border-purple-100">
          <div className="text-5xl font-mono font-bold text-purple-800 mb-4">
            xⁿ · xᵐ = xⁿ⁺ᵐ
          </div>
        </div>
