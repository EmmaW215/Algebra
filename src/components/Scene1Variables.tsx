...
export default function Scene1Variables({ onNext }: { onNext: () => void }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-center space-y-8">
      ...
      >
        Think of a variable as a box that can hold different numbers.
        Usually, we use a letter like <span className="font-mono font-bold text-indigo-600">x</span> or <span className="font-mono font-bold text-indigo-600">y</span>.
      </motion.p>

      <div className="flex items-center justify-center space-x-12 min-h-[200px]">
        {/* The Variable Box */}
        ...
        <div className="flex flex-col space-y-4">
          <p className="text-sm text-slate-500 font-medium">Click a number to put it in the box:</p>
      ...
      >
        {value !== null && (
          <p className="text-xl font-medium text-slate-800">
            Right now, <span className="font-mono text-indigo-600">x = {value}</span>
          </p>
        )}
      </motion.div>
